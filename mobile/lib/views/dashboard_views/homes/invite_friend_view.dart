...
class _InviteFriendViewState extends State<InviteFriendView> {
  ...
  @override
  void initState() {
    context.read<MentorLogic>().add(FetchingAllUserEvent());
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            margin: EdgeInsets.only(
                left: width * 0.08, right: width * 0.08, bottom: 10),
      ...
      body: BlocBuilder<MentorLogic, MentorState>(builder: (context, state) {
        ...
        } else if (state is FetchingAllUserState) {
          var data = state.allUserModel;
          return _buildBody(data, width, height);
        } else {
          return Container();
        }
      }),
  ...
  Widget _buildBody(AllUserModel userModel, double width, double height) {
